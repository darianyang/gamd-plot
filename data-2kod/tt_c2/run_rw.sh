...
# for tt and c2
python ../../py_reweighting/PyReweighting-2D.py -input agg_tt_c2.dat -T 298 -Emax 15 -cutoff 10 -discX 0.12 -Xdim 6 18 -discY 0.8 -Ydim 20 100 -job amdweight_CE -weight ../agg_2kod_weights.dat
